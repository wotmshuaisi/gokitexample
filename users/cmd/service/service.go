...
import (
	...
	endpoint "github.com/wotmshuaisi/gokitexample/users/pkg/endpoint"
	http "github.com/wotmshuaisi/gokitexample/users/pkg/http"
	service "github.com/wotmshuaisi/gokitexample/users/pkg/service"
...
var debugAddr = fs.String("debug.addr", ":8087", "Debug and metrics listen address")
var httpAddr = fs.String("http-addr", ":8088", "HTTP listen address")
var grpcAddr = fs.String("grpc-addr", ":8089", "gRPC listen address")
